             ...
             <div class="card card-compact bg-base-100">
                <figure><img src="https://i.ibb.co/L1b6xSq/shape.jpg" alt="Shoes" /></figure>
                 <div class="card-body flex flex-row justify-center">
                    <img class="w-12 rounded-full" src="https://i.ibb.co/D9wWRM6/olivia.jpg" alt="">
                    <h2 class="font-bold pl-2">Building a Winning UX Strategy Using the Kano Model</h2>
                    </div>
                 <div class="text-[#171717B3]">
                    <div class="flex pl-10 items-center">
                        <h2 class="pr-3">Awlad Hossain</h2>
                        <svg class="hidden" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none"><g clip-path="url(#clip0_11_34)">
                        ...
                        <h3 class="pl-11 mb-4">Total views</h3>
                    </div>
                  </div>
        `
